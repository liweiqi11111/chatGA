...
def get_messages(session, conv_id: int, page: int = 1, page_size: int = 10):
    ...
    messages = [{"msg_id": message.msg_id, "conv_id": message.conv_id, "role": message.role, 
                 "content": message.content, "content_type": message.content_type, "create_time": message.create_time}
